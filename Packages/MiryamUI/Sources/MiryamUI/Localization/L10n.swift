...
public enum L10n {
    ...
    public static let skipBackward15: LocalizedStringResource = "Skip backward 15 seconds"
    public static let skipForward15: LocalizedStringResource = "Skip forward 15 seconds"
